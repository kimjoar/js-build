...
define('component/subViewHandler',['require','underscore'],function(require) {
...
define('base/view',['require','jquery','underscore','backbone','component/subViewHandler'],function(require) {
...
define('component/eventBus',['require','underscore','backbone'],function(require) {
...
define("hgn!modules/user/userDetail", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("Age: ");_.b(_.v(_.f("age",c,p,0)));_.b("\n");return _.fl();;}, "", hogan);  return function(){ return tmpl.render.apply(tmpl, arguments); };});

define('modules/user/userDetailView',['require','base/view','hgn!./userDetail'],function(require) {
...
define("hgn!modules/user/user", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<h1>Name: ");_.b(_.v(_.f("name",c,p,0)));_.b("</h1>");_.b("\n" + i);_.b("\n" + i);_.b("<div class=\"user-detail\"></div>");_.b("\n");return _.fl();;}, "", hogan);  return function(){ return tmpl.render.apply(tmpl, arguments); };});

define('modules/user/userView',['require','base/view','component/eventBus','./userDetailView','hgn!./user'],function(require) {
...
define('component/sync',['require','underscore','backbone'],function(require) {
...
define('base/model',['require','backbone','component/sync'],function(require) {
...
define('modules/user/user',['require','base/model'],function(require) {
...
define('router',['require','backbone','modules/user/userView','modules/user/user'],function(require) {
...
define('component/section',['underscore'], function(_) {
...
define("hgn!modules/app/app", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div id=\"menu\"></div>");_.b("\n" + i);_.b("<div id=\"main\"></div>");_.b("\n" + i);_.b("\n");return _.fl();;}, "", hogan);  return function(){ return tmpl.render.apply(tmpl, arguments); };});

define('modules/app/app',['require','jquery','underscore','router','base/view','component/section','hgn!./app'],function(require) {
...
define('main',['require','jquery','backbone','modules/app/app'],function(require) {
